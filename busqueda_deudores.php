  ...
  <tr>
    ...
    <td width="294"><form name="registro" method="post" action="delete.php">
        <table width="284" border="0">
          ...
          <tr>
		  <td height="32" colspan="2">Si la Persona hace parte de Su Lista de Deudores Lo puede Eliminar¡¡¡</td></tr>
		  <tr>
            <td height="32" colspan="2"><p><span class=EstiloError>Deudor Encontrado!!!<img src =imagenes/alarma.png width = 30 height = 30></span></p></td>
          </tr>
          <tr>
            <td height="32" colspan="2"><a href="busqueda_deudores.php">Atras </a></td>
          </tr>
          <tr>
...
echo '
		  ...
		  <tr>
		  <td colspan="2">
		    <p><a href="dentro.php"><img src="log-in.png" alt="Atras" width="48" height="48" border="0" /></a>
...
';
 ...
 {
 header("Location: buscar_deudor.php?Error2=si");
 }
}
else{   
      header("Location: buscar_deudor.php?Error=si");
   }
